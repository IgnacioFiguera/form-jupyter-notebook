...
const ListInternal = (0, _react.forwardRef)((_ref, forwardedRef) => {
  let children = _ref.children,
      ...
      props = _objectWithoutProperties(_ref, ["children", "density", "disabled", "height", "iconGutter", "keyColor", "onBlur", "onFocus", "onKeyDown", "role", "windowing"]);

  const childArray = (0, _react.useMemo)(() => _react.Children.toArray(children), [children]);
  const itemDimensions = (0, _utils2.listItemDimensions)(density !== undefined ? density : 0);
  ...
  const _useWindow = (0, _utils.useWindow)({
    childHeight: childArray[0] ? getListItemHeight(childArray[0], itemDimensions.height) : 0,
    children: children,
...
const ListStyle = _styledComponents.default.ul.withConfig({
  shouldForwardProp: _designTokens.shouldForwardProp
}).withConfig({
  displayName: "List__ListStyle",
  componentId: "q1s69i-0"
})(["", " ", " ", " list-style:none;overflow:auto;"], _designTokens.reset, _styledSystem.height, _designTokens.width);

const List = (0, _styledComponents.default)(ListInternal).withConfig({
  displayName: "List",
  componentId: "q1s69i-1"
})([""]);
exports.List = List;
