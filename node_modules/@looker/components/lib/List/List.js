...
import { reset, shouldForwardProp, width } from '@looker/design-tokens';
...
export var ListInternal = forwardRef(function (_ref, forwardedRef) {
  ...
  var itemDimensions = listItemDimensions(density !== undefined ? density : 0);
...
})(["", " ", " ", " list-style:none;overflow:auto;"], reset, height, width);
